...
| `validation/krylov_projected_control_results.md` | **contrôle Krylov projeté P_H^{G_p} (2026-08-17) : la géométrie Krylov + thermodynamique bat le réseau dissipatif de 0,19–0,25 à rang égal, utile mais pas « strategy-changing » (0,402 vs barre 0,386, après correction de la transposée G_p attrapée par le check FD)** |
