...
build_dir="${SRIX_GENERIC_BUILD_DIR:-${repository_dir}/build/srix-generic}"
source_file="${build_dir}/Fcc316LForestRubinSrixGeneric3D.mfront"
...
"${repository_dir}/.venv/bin/python" \
  "${repository_dir}/scripts/generate_srix_generic_3d.py" \
