...
| EBSD, DIC, mapping, registration, axes | [`docs/reference/scientific/ebsd_orientation_contract.md`](../reference/scientific/ebsd_orientation_contract.md), [`docs/reference/dic_axis_conventions.md`](../reference/dic_axis_conventions.md) and [`docs/adr/0004-dic-input-preparation.md`](../adr/0004-dic-input-preparation.md) | current registration audit |
