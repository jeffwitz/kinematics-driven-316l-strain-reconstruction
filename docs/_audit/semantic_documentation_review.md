...
| FEMU and SVD | incomplete | blocked | open | no registered production boundary-only FEMU driver; free-field DIC observability is documented as a prerequisite, distinct from parametric FEMU SVD |
